from aws_cdk import aws_cognito as cognito, aws_iam as iam, aws_ssm as ssm, Stack
...
class CognitoStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        user_pool_client = cognito.CfnUserPoolClient(
            self, "pool-client", user_pool_id=user_pool.ref, client_name=env_name + "-app-client"
        )
        ...
        identity_pool = cognito.CfnIdentityPool(
            ...
            cognito_identity_providers=[
                cognito.CfnIdentityPool.CognitoIdentityProviderProperty(
                    client_id=user_pool_client.ref, provider_name=user_pool.attr_provider_name
                )
            ],
        ...
        ssm.StringParameter(
            self, "app-id", parameter_name="/" + env_name + "/cognito-app-client-id", string_value=user_pool_client.ref
        )
